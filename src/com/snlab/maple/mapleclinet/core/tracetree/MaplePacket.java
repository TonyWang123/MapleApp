...
import com.snlab.maple.mapleclinet.core.packet.IPv4;
import com.snlab.maple.mapleclinet.core.packet.TCP;
...
public class MaplePacket {
    ...
    public MaplePacket(Ethernet frame, Port ingressPort, MapleCore mapleCore) {
        this.frame = frame;
